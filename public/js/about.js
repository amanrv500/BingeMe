...
.then(res => res.json())
.then(data => {
    let movieStream = document.querySelector('.movie-stream');   
    
        movieStream.innerHTML += `
        <iframe src="https://imdbembed.xyz/movie/tmdb/${data.id}" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture
